---
title: 🔗 Sumber Resmi & Pendaftaran EX200 (RHCSA)
---

Halaman ini mengumpulkan **tautan resmi**, informasi pendaftaran, biaya,
bahasa ujian, dan tips mendaftar — supaya panduan ini benar-benar _powerfull_
...
- **Kode**: EX200 (RHCSA).
- **Tipe**: _performance-based_ — kerjakan tugas nyata di VM RHEL, bukan pilihan ganda.
...
4. Pilih **lokasi**: bisa _onsite_ (Pusat Ujian Red Hat/Partner) atau
...
- Lanjut ke **RHCE (EX294, Ansible)** untuk jalur _Red Hat Certified Engineer_.
