...
> padanan **KBBI**, mis. _berkas_ (bukan "file"), _direktori_ (bukan "folder"),
> _penyunting teks_ (bukan "text editor"), _perangkat_ (bukan "device").
...
| **context**               | Label keamanan `usertype:level` milik SELinux                        |
